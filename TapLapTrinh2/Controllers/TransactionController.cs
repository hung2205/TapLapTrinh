...
namespace TapLapTrinh2.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public TransactionController(ApplicationtestDBContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationtestDBContext = _context.Transactions.Include(t => t.Category);
            return View(await applicationtestDBContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationtestDBContext.Transactions'  is null.");
            }
